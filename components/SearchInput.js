...
export default function SearchInput({searchData}) {
  ...
  return <>
    <div style={searchInputStyle} className={searchInputStyle.border !== "none" ? styles.searchInputChange : styles.searchInput}>
      ...
      <input onKeyDown={inputKeyDown} onFocus={changeFocusInputStyle} onBlur={changeBlurInputStyle} value={searchText} onChange={e => handleChange(e.target.value)} type="text" placeholder="Имя питомца"/>
    </div>
  </>

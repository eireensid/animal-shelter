...
export default function SearchInput({searchData}) {
  ...
  return <>
    <div onFocus={changeFocusInputStyle} onBlur={changeBlurInputStyle} style={searchInputStyle} className={searchInputStyle.border !== "none" ? styles.searchInputChange : styles.searchInput}>
      <div onMouseOver={changeStyleHover} onMouseOut={removeHover} style={searchInputImgDivStyle} className={searchInputImgDivStyle.background !== "none" ? styles.searchInputImgDivChange : ""}>
